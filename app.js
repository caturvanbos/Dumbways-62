...
function renderCard(project, callback) {
  ...
  project.technologies.forEach(tech => {
    ...
    if (value === "android") iconsHTML += `<i class="fa-brands fa-android"></i>`;
    if (value === "java") iconsHTML += `<i class="fa-brands fa-java"></i>`;
    if (value === "playstore") iconsHTML += `<i class="fa-brands fa-google-play"></i>`;
    if (value === "node js") iconsHTML += `<i class="fa-brands fa-node-js"></i>`;
    if (value === "react js") iconsHTML += `<i class="fa-brands fa-react"></i>`;
  });
...
// Render semua project dan pasang event klik
  ...
  renderCard(project, card => {
    card.addEventListener("click", () => {
      ...
      project.technologies.forEach(tech => {
        ...
        if (value === "android") techHTML += `<div class="tech-item"><i class="fa-brands fa-android"></i><span>Android</span></div>`;
        if (value === "java") techHTML += `<div class="tech-item"><i class="fa-brands fa-java"></i><span>Java</span></div>`;
        if (value === "playstore") techHTML += `<div class="tech-item"><i class="fa-brands fa-google-play"></i><span>Play Store</span></div>`;
      });
